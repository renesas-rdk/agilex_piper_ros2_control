...
Usage:
  ...
  ros2 launch agilex_piper_ros2_control agilex_piper_joint_position_control.launch.py can_interface:=can1

  # For arm-only configuration (without gripper):
  ros2 launch agilex_piper_ros2_control agilex_piper_joint_position_control.launch.py include_gripper:=false

  # For SIMULATION/TESTING without physical robot (RECOMMENDED for testing):
  ros2 launch agilex_piper_ros2_control agilex_piper_joint_position_control.launch.py use_mock_hardware:=true
